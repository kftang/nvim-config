...
-- NOTE: My custom settings, no changes were made to the kickstart defaults above
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Copied from https://github.com/nvim-lua/kickstart.nvim/pull/1663/files
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- preset = 'default',
        --
        -- Custom keymap inspired from https://www.reddit.com/r/neovim/comments/1hlnv7x/blinkcmp_i_finally_have_a_configuration_that/
